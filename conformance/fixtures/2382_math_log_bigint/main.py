...
big = 10 ** 1000
show("log_big", lambda: math.log(big))
show("log2_big", lambda: math.log2(big))
show("log10_big", lambda: math.log10(big))
show("log_big_base10", lambda: math.log(big, 10))
show("log_big_base2", lambda: math.log(big, 2))
show("log2_2pow", lambda: math.log2(1 << 2000))
show("log10_10pow", lambda: math.log10(10 ** 500))
show("log_hugebase", lambda: math.log(10 ** 600, 10 ** 300))
show("log_biggest", lambda: math.log(1 << 100000))

# Ints that still fit a double take the ordinary path.
show("log_int", lambda: math.log(123456789))
show("log2_exact", lambda: math.log2(2 ** 60))
show("log10_1000", lambda: math.log10(1000))
...
show("log_base", lambda: math.log(8, 2))
show("log_base_e", lambda: math.log(math.e))
