...
func TestGetAttrDefault(t *testing.T) {
	...
	got, err := GetAttr([]objects.Object{e, objects.NewStr("args")})
	if err != nil {
...
func TestSetAttrOnException(t *testing.T) {
	...
	got, err := SetAttr([]objects.Object{e, objects.NewStr("__cause__"), cause})
...
func TestAttrArity(t *testing.T) {
	...
	_, err = GetAttr([]objects.Object{e, e, e, e})
	...
	_, err = SetAttr([]objects.Object{e, e})
