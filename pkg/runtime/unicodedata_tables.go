...
// decimal/digit/numeric values, the Bidi_Mirrored flag, the Bidi_Class ranges, the
// general-category ranges, and the UCD version. Hangul syllables are handled
// arithmetically in unicodedatamod.go and are absent from the decomposition tables
// here.
...
var ucdCategoryRanges = []categoryRange{
	{0x0, 0x1F, "Cc"},
	{0x20, 0x20, "Zs"},
	{0x21, 0x23, "Po"},
	{0x24, 0x24, "Sc"},
