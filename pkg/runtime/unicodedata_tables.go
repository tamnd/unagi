...
// decimal/digit/numeric values, the Bidi_Mirrored flag and the Bidi_Class ranges.
// Hangul syllables are handled arithmetically in unicodedatamod.go and are absent
// from the decomposition tables here.
