...
func init() {
	...
	register(map[string]objects.Object{
		...
		"getattr":  objects.NewFuncT("getattr", -1, GetAttr),
		"hasattr":  objects.NewFuncT("hasattr", -1, HasAttr),
		"setattr":  objects.NewFuncT("setattr", -1, SetAttr),
		"delattr":  objects.NewFuncT("delattr", -1, DelAttr),
