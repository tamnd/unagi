...
// version, so category and the reported version name the same data. The one
// remaining UCD property this does not bundle is the name database, so name and
// lookup carry the best-effort behavior documented on each.
