...
var floorDynamicCore = map[string][]string{
	"encodings": {"utf_8", "utf_8_sig", "ascii", "latin_1", "gb2312", "gbk", "shift_jis", "cp932", "euc_jp", "euc_kr", "cp949", "johab", "shift_jis_2004", "shift_jisx0213", "euc_jis_2004", "euc_jisx0213", "big5", "cp950", "big5hkscs", "gb18030", "hz", "iso2022_jp"},
}
