...
// pkg/runtime, pkg/sre, and pkg/frontend (the runtime's eval() reparses source
// through it) with a dependency-free go.mod, so building it never resolves
...
var floorDynamicCore = map[string][]string{
	"encodings": {"utf_8", "utf_8_sig", "utf_16", "utf_16_le", "utf_16_be", "utf_32", "utf_32_le", "utf_32_be", "unicode_escape", "raw_unicode_escape", "utf_7", "ascii", "latin_1", "gb2312", "gbk", "shift_jis", "cp932", "euc_jp", "euc_kr", "cp949", "johab", "shift_jis_2004", "shift_jisx0213", "euc_jis_2004", "euc_jisx0213", "big5", "cp950", "big5hkscs", "gb18030", "hz", "iso2022_jp", "iso2022_jp_1", "iso2022_jp_ext", "iso2022_jp_3", "iso2022_jp_2004", "iso2022_jp_2", "iso2022_kr",
		// The generic charmap codec (a None mapping falls back to latin-1) and the
		// single-byte charmap codecs, all built on _codecs.charmap_build/encode/decode.
		"charmap",
		...
		// The pure-Python algorithmic codecs.
		"rot_13", "punycode", "idna"},
}
...
func writeModule(genDir string, goSrc, staticSrc []byte, mods []pymod) error {
	...
	for _, pkg := range []string{"objects", "runtime", "sre", "pytoken", "pylexer", "frontend"} {
