...
func TestParse(t *testing.T) {
	tests := []struct {
		...
		{"generic def erases type params", "def f[T](x): return x", "(def f (x) [(return x)])"},
		{"generic def bound and default", "def f[T: int, U = str](x): pass", "(def f (x) [(pass)])"},
		{"generic def variadic params", "def f[*Ts, **P](x): pass", "(def f (x) [(pass)])"},
		...
		{"generic class erases type params", "class C[T]: pass", "(class C () [(pass)])"},
		{"generic class bound with base", "class C[T: int](A): pass", "(class C (A) [(pass)])"},
